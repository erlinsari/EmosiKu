...
def render_premium_ui():
    # Mengambil aset dari root (yang sudah kita pindahkan tadi)
    assets_path = "assets"
    ...
    if js_file and css_file:
        ...
        # Potong-potong kode JS agar tidak terlalu berat saat dikirim lewat satelit internet
        # Kita bagi menjadi potongan 50KB
        chunk_size = 50000
        ...
        <body>
            <div id="root">
                <div style="display:flex; flex-direction:column; justify-content:center; align-items:center; height:100vh; font-family:sans-serif; color:#64748b;">
                    ...
                    <div>Menyusun Antarmuka Premium...</div>
                </div>
            </div>
            <script>
                (function() {{
                    try {{
                        ...
                        document.body.innerHTML = '<h3 style="color:red; padding:20px;">Gagal: ' + e.message + '</h3>';
                    }}
                }})();
            </script>
        </body>
